class SPClassOddsHistoryListEntity {
	...
	SPClassOddsHistoryListEntity.fromJson(Map<String, dynamic> json) {
		if (json["odds_history_list"] != null) {
			spProOddsHistoryList = new List<SPClassOddsHistoryListOddsHistoryList>();(json["odds_history_list"] as List).forEach((v) { spProOddsHistoryList.add(new SPClassOddsHistoryListOddsHistoryList.fromJson(v)); });
		}
	}
