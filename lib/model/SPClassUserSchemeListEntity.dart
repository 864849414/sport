class SPClassUserSchemeListEntity {
	...
	SPClassUserSchemeListEntity.fromJson(Map<String, dynamic> json) {
		if (json["user_scheme_list"] != null) {
			spProUserSchemeList = new List<SPClassUserSchemeListUserSchemeList>();(json["user_scheme_list"] as List).forEach((v) { spProUserSchemeList.add(new SPClassUserSchemeListUserSchemeList.fromJson(v)); });
		}
	}
