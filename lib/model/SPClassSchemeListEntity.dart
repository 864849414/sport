class SPClassSchemeListEntity {
	...
	SPClassSchemeListEntity.fromJson(Map<String, dynamic> json) {
		if (json["scheme_list"] != null) {
			spProSchemeList = new List<SPClassSchemeListSchemeList>();(json["scheme_list"] as List).forEach((v) { spProSchemeList.add(new SPClassSchemeListSchemeList.fromJson(v)); });
		}
	}
