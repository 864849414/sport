...
class SPClassAnylizeMatchList {
	...
	SPClassAnylizeMatchList.fromJson(Map<String, dynamic> json) {
		if (json['team_one_future'] != null) {
			spProTeamOneFuture = new List<SPClassEntityHistory>();(json['team_one_future'] as List).forEach((v) { spProTeamOneFuture.add(new SPClassEntityHistory.fromJson(v)); });
		}
		if (json['team_two_history'] != null) {
			spProTeamTwoHistory = new List<SPClassEntityHistory>();(json['team_two_history'] as List).forEach((v) { spProTeamTwoHistory.add(new SPClassEntityHistory.fromJson(v)); });
		}
		if (json['team_points_list'] != null) {
			spProTeamPointsList = new List<SPClassTeamPointsList>();(json['team_points_list'] as List).forEach((v) { spProTeamPointsList.add(new SPClassTeamPointsList.fromJson(v)); });
		}
		if (json['team_one_history'] != null) {
			spProTeamOneHistory = new List<SPClassEntityHistory>();(json['team_one_history'] as List).forEach((v) { spProTeamOneHistory.add(new SPClassEntityHistory.fromJson(v)); });
		}
		if (json['team_two_future'] != null) {
      spProTeamTwoFuture = new List<SPClassEntityHistory>();(json['team_two_future'] as List).forEach((v) { spProTeamTwoFuture.add(new SPClassEntityHistory.fromJson(v)); });
		}
		spProMatchExist = json['match_exist'];
		if (json['history'] != null) {
			history = new List<SPClassEntityHistory>();(json['history'] as List).forEach((v) { history.add(new SPClassEntityHistory.fromJson(v)); });
		}
    if (json['team_list'] != null) {
      team_list = new List<SPClassTeamList>();(json['team_list'] as List).forEach((v) { team_list.add(new SPClassTeamList.fromJson(v)); });
    }
	}
