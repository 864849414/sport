  ...
  SPClassExpertListEntity({this.spProExpertList});
	...
	SPClassExpertListEntity.fromJson(Map<String, dynamic> json) {
		if (json['expert_list'] != null) {
			spProExpertList = new List<SPClassExpertListExpertList>();(json['expert_list'] as List).forEach((v) { spProExpertList.add(new SPClassExpertListExpertList.fromJson(v)); });
		}
	}
