...
class SPClassSsOddsList {
	List<SPClassSsOddsItem> spProListOP=List();
	List<SPClassSsOddsItem> spProListDX=List();
	List<SPClassSsOddsItem> spProListYP=List();
	List<SPClassSsOddsItem> spProListLOLSF=List();
	List<SPClassSsOddsItem> spProListLOLRF=List();
	...
	SPClassSsOddsList.fromJson(Map<String, dynamic> jsonOrg) {
      ...
      if (json["欧赔"] != null) {
        spProListOP = new List<SPClassSsOddsItem>();(json["欧赔"] as List).forEach((v) { spProListOP.add(new SPClassSsOddsItem.fromJson(v)); });
      }
      if (json["大小"] != null) {
        spProListDX = new List<SPClassSsOddsItem>();(json["大小"] as List).forEach((v) { spProListDX.add(new SPClassSsOddsItem.fromJson(v)); });
      }
      if (json["亚盘"] != null) {
        spProListYP = new List<SPClassSsOddsItem>();(json["亚盘"] as List).forEach((v) { spProListYP.add(new SPClassSsOddsItem.fromJson(v)); });
      }
      if (json["让分胜负"] != null) {
        spProListLOLRF = new List<SPClassSsOddsItem>();(json["让分胜负"] as List).forEach((v) { spProListLOLRF.add(new SPClassSsOddsItem.fromJson(v)); });
      }
      if (json["胜负"] != null) {
        spProListLOLSF = new List<SPClassSsOddsItem>();(json["胜负"] as List).forEach((v) { spProListLOLSF.add(new SPClassSsOddsItem.fromJson(v)); });
      }
    }
