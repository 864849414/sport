...
class SPClassNewVideoPage extends StatefulWidget // ignore: must_be_immutable
    {
  SPClassNewVideoPageState spProState;
  SPClassNewVideoPageState createState()=>SPClassNewVideoPageState();

}

class SPClassNewVideoPageState extends State<SPClassNewVideoPage> with AutomaticKeepAliveClientMixin
{
  ...
  Future<void> spFunOnRefresh() async{
    ...
    ) ,queryParameters: {"info_flow_type":"video","ref_info_flow_key":spProListData.length==0? "":spProReFreshInfoFlowKey,"direction":spProListData.length==0? "":"before"});
  }
