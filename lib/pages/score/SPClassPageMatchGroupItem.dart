...
import 'package:sport/pages/score/SPClassMatchBasketballView.dart';
import 'package:sport/pages/score/SPClassMatchFootballView.dart';
...
class SPClassPageMatchGroupItemState extends State<SPClassPageMatchGroupItem> with AutomaticKeepAliveClientMixin,TickerProviderStateMixin{
  ...
  List<SPClassGuessMatchInfo> spProDataList=List();
                  ...
                  ExpandIcon(
                    ...
                    onPressed: (value)=>{
                      setState(() {
                        ...
                        spProExpaned=!value;
                        if((spProDataList.length==0&&spProExpaned)||(spProBeforeLeague.spProLeagueName!=widget.spProLeagueInfo.spProLeagueName&&spProExpaned)){
                          spFunOnRefresh();
                        }
                      })
                    },
