        ...
        child: Column(
          children: <Widget>[
            ...
            Visibility(
              ...
              visible: SPClassHomePageState.spProHomeMatchType=="足球",
            ),
                ...
                children:[
                  ...
                  return Container(
                    ...
                    child: Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        Text(item["title"],style: TextStyle(color: Color(0xFF333333),fontSize: sp(13),fontWeight: FontWeight.w500),),
                        Expanded(child: Row(
                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Row(
                                children: <Widget>[
                                  SPClassEncryptImage.asset(SPClassImageUtil.spFunGetImagePath(list.contains("audio")? "ic_select":"ic_seleect_un"), width: width(15)),
                                  SizedBox(width: width(5),),
                              ...
                              onTap: (){
                                ...
                                spFunUpdateSetting(promptValue,item["key"]);
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: <Widget>[
                                  SPClassEncryptImage.asset(SPClassImageUtil.spFunGetImagePath(list.contains("vibrate")?  "ic_select":"ic_seleect_un"), width: width(15)),
                                  SizedBox(width: width(5),),
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: <Widget>[
                                  SPClassEncryptImage.asset(SPClassImageUtil.spFunGetImagePath(list.contains("alert")?  "ic_select":"ic_seleect_un"), width: width(15)),
                                  SizedBox(width: width(5),),
            ...
            Visibility(
              ...
              visible: SPClassHomePageState.spProHomeMatchType=="足球"&&Platform.isAndroid,
            ),
