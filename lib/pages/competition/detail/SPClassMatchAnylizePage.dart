...
import 'package:sport/Demo.dart';
        ...
        spProCallBack: SPClassHttpCallBack<SPClassAnylizeMatchList>(
          ...
          if (spProAnylizeMatchList != null) {
            ...
            if (spProAnylizeMatchList.spProTeamTwoHistory != null &&
                spProAnylizeMatchList.spProTeamTwoHistory.length > 0) {
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Container(
                                                ...
                                                // Text(spFunGetHistoryResultText(item,winTeam: 2),style: TextStyle(
                                                //   fontSize: sp(11),
                        ...
                        GestureDetector(
                          child: Container(
                            decoration: (spProForecastInfo != null &&
                                    spProForecastInfo.spProSupportWhich !=
                                        null &&
                                    spProForecastInfo.spProSupportWhich == "1")
                                ? BoxDecoration(boxShadow: [
                                    BoxShadow(
                                        color:
                                            Color(0x66FF9613).withOpacity(0.1),
                                        offset: Offset(5, 1),
                                        blurRadius: width(10))
                                  ])
                                : null,
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    ...
                    child: Text(
                      "?",
                      style: TextStyle(color: Colors.white, fontSize: sp(8)),
                    ),
                    width: width(16),
                    height: width(16),
                    decoration: BoxDecoration(
                        color: Color(0xFFB5B5B5), shape: BoxShape.circle),
                  ),
                ],
              ),
              onTap: () {
                        ...
                        Container(
                          ...
                          child: Text(
                            (spFunGetMatchAllPointsScore(1, "全部") +
                                ...
                                .toStringAsFixed(0),
                            style: TextStyle(
                                fontSize: sp(12), color: Color(0xFF333333)),
                          ),
                        ),
                        SizedBox(
                          width: width(8),
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                flex: (spFunAvgWinOrLoseScoreOne(true) * 100)
                                    .toInt(),
                                child: Container(
                                  margin: EdgeInsets.only(right: 2),
                                  alignment: Alignment.center,
                              ...
                              Expanded(
                                flex: (spFunAvgWinOrLoseScoreTwo(true) * 100)
                                    .toInt(),
                                child: Container(
                                  decoration: BoxDecoration(
                                      color: Color(0xFFFF5F40),
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Row(
                            children: <Widget>[
                              Expanded(
                                flex: (spFunAvgWinOrLoseScoreTwo(false) * 100)
                                    .toInt(),
                                child: Container(
                                  margin: EdgeInsets.only(right: 2),
                                  alignment: Alignment.center,
                              ...
                              Expanded(
                                flex: (spFunAvgWinOrLoseScoreOne(false) * 100)
                                    .toInt(),
                                child: Container(
                                  decoration: BoxDecoration(
                                      color: Color(0xFFFF5F40),
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        "积分排名",
                        style: TextStyle(
                            fontSize: sp(16), fontWeight: FontWeight.bold),
                      ),
                    ),
                    Container(
                      width: width(140),
                          ...
                          Expanded(
                            child: FlatButton(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.horizontal(
                                        right: Radius.circular(width(12))),
                                    color: spProPointsKey == "客"
                                        ? MyColors.main1
                                        : Color(0xFFF2F2F2)),
                                alignment: Alignment.center,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                "球队",
                                style: TextStyle(
                                    fontSize: sp(11), color: Color(0xFF888888)),
                              ),
                            ),
                          ),
                          Expanded(
                    ...
                    Container(
                      child: Column(
                        children:
                            spFunGetTeamPoints(spProPointsKey).map((item) {
                          return Container(
                            height: width(43),
                            decoration: BoxDecoration(
                                color: Colors.white,
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(
                                      sprintf("%s%", [
                                        (double.parse(item.spProWinRate) * 100)
                                            .toStringAsFixed(0)
                                      ]),
                                      style: TextStyle(
                                          fontSize: sp(11),
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(
                                      sprintf("%s/%s",
                                          [item.score, item.spProLoseScore]),
                                      style: TextStyle(
                                          fontSize: sp(11),
                                          fontWeight: FontWeight.w500),
                                    ),
                        ...
                        Expanded(
                          child: FlatButton(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.only(
                                      bottomLeft: Radius.circular(width(12)),
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        sprintf(
                          ...
                          [
                            spFunGetMatchCount(
                                spFunGetHistoryList(spProHistoryKey), 1),
                            spFunGetMatchCount(
                                spFunGetHistoryList(spProHistoryKey), 0),
                            spFunGetMatchCount(
                                spFunGetHistoryList(spProHistoryKey), 2),
                          ],
                        ),
                        style: TextStyle(fontSize: sp(12)),
                      ),
                ...
                children: <Widget>[
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Text(
                              "赛事日期",
                              style: TextStyle(
                                  fontSize: sp(11), color: Color(0xFF303133)),
                            ),
                          ),
                        ),
                        Expanded(
                  ...
                  Container(
                    child: ListView.builder(
                      ...
                      shrinkWrap: true,
                      physics: NeverScrollableScrollPhysics(),
                      itemCount: spFunGetHistoryList(spProHistoryKey).length,
                      itemBuilder: (c, index) {
                        var item = spFunGetHistoryList(spProHistoryKey)[index];
                        // return Demo();
                        return Container(
                          decoration: BoxDecoration(
                              color: Colors.white,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                width: width(30),
                                child: Text(
                                  spFunGetHistoryResultText(item),
                                  style: TextStyle(
                                    fontSize: sp(11),
                                    color: spFunGetResultColor(item),
                                  ),
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Container(
                            constraints: BoxConstraints(maxWidth: width(79)),
                            child: Text(
                              '${widget.spProGuessMatch.spProTeamOne}:',
                              style: TextStyle(fontSize: sp(12)),
                              maxLines: 1,
                        ...
                        Text(
                          sprintf("%d胜%d平%d负", [
                            spFunGetMatchCount(
                                spFunGetHistoryOneList(spProHistoryOneKey), 1),
                            spFunGetMatchCount(
                                spFunGetHistoryOneList(spProHistoryOneKey), 0),
                            spFunGetMatchCount(
                                spFunGetHistoryOneList(spProHistoryOneKey), 2),
                          ]),
                          style: TextStyle(
                            fontSize: sp(12),
                          ),
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: SfCircularChart(
                                      ...
                                      legend: Legend(isVisible: false),
                                      series: [
                                        DoughnutSeries<SPClassChartDoughnutData,
                                            String>(
                                          explode: false,
                                          explodeIndex: 0,
                                          radius: width(30).toString(),
                  ...
                  Container(
                    decoration: BoxDecoration(
                        border:
                            Border.all(color: Color(0xFFDDDDDD), width: 0.4)),
                    alignment: Alignment.center,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: <Widget>[
                        ...
                        Container(
                          child: Column(
                            children: spFunGetHistoryOneList(spProHistoryOneKey)
                                .map((item) {
                              return Container(
                                height: width(43),
                                decoration: BoxDecoration(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text(
                        sprintf("%d胜%d平%d负", [
                          spFunGetMatchCount(
                              spFunGetHistoryTwoList(spProHistoryTwoKey), 1,
                              winTeam: 2),
                          spFunGetMatchCount(
                              spFunGetHistoryTwoList(spProHistoryTwoKey), 0,
                              winTeam: 2),
                          spFunGetMatchCount(
                              spFunGetHistoryTwoList(spProHistoryTwoKey), 2,
                              winTeam: 2),
                        ]),
                        style: TextStyle(
                          fontSize: sp(12),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child: Column(
                          children: spFunGetHistoryTwoList(spProHistoryTwoKey)
                              .map((item) {
                            return Container(
                              height: width(44),
                              decoration: BoxDecoration(
...
//  未来赛事
    ...
    return Visibility(
      child: Container(
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(width(7))),
        margin:
            EdgeInsets.only(left: width(10), right: width(10), top: width(10)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Stack(
              ...
              children: <Widget>[
                SPClassEncryptImage.asset(
                  SPClassImageUtil.spFunGetImagePath("ic_match_statc_title"),
                  width: width(319),
                ),
                Text(
                  "未来赛事",
                  style:
                      TextStyle(fontSize: sp(16), fontWeight: FontWeight.bold),
                )
              ],
            ),
            AnimatedSize(
              ...
              child: Column(
                children: <Widget>[
                  Visibility(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            (widget.spProGuessMatch.spProIconUrlOne.isEmpty)
                                ? SPClassEncryptImage.asset(
                                    SPClassImageUtil.spFunGetImagePath(
                                        "ic_team_one"),
                                    width: width(20),
                                        ...
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              height: width(40),
                                              child: Text(
                                                "${(DateTime.parse(item.spProStTime).difference(DateTime.now()).inDays + 1).toString()}" +
                                                    "天",
                                                style: TextStyle(
                                                  fontSize: sp(11),
                                                ),
                    ...
                    visible:
                        SPClassListUtil.spFunIsNotEmpty(spProFutureListOne),
                  ),
                  Visibility(
                    child: Column(
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            (widget.spProGuessMatch.spProIconUrlTwo.isEmpty)
                                ? SPClassEncryptImage.asset(
                                    SPClassImageUtil.spFunGetImagePath(
                                        "ic_team_two"),
                                    width: width(20),
                    ...
                    visible:
                        SPClassListUtil.spFunIsNotEmpty(spProFutureListTwo),
                  ),
                ],
              ),
            ),
  ...
  void spFunInitPointData() {
    if (spProAnylizeMatchList.spProTeamPointsList != null &&
        spProAnylizeMatchList.spProTeamPointsList.length > 0) {
