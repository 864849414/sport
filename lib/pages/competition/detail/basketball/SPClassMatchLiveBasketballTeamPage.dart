...
class SPClassMatchLiveBasketballTeamPageState extends State<SPClassMatchLiveBasketballTeamPage> with TickerProviderStateMixin<SPClassMatchLiveBasketballTeamPage> ,AutomaticKeepAliveClientMixin{
  ...
  List<SPClassTextLiveListTextLiveList> spProOrgTextData=List();
  List<SPClassTextLiveListTextLiveList> spProShowTextData=List();
  Timer spProTimer;
  int hour=0;
  int minute=0;
  int second=0;
        ...
        spProOnSuccess: (result) async {
          if(result!=null){
            ...
            if(result.spProPlayerStatList!=null){
              if(result.spProPlayerStatList.one!=null&&result.spProPlayerStatList.one.length>0){
                spProPlayerOneDateList=result.spProPlayerStatList.one;
                spProPlayerOneDateList.insert(0, null);
              }
              if(result.spProPlayerStatList.two!=null&&result.spProPlayerStatList.two.length>0){
                spProPlayerTwoDateList=result.spProPlayerStatList.two;
                spProPlayerTwoDateList.insert(0, null);
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        child: ( widget.spProGuessInfo.spProIconUrlOne.isEmpty)? SPClassEncryptImage.asset(
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(width: 4,),
                                      Container(
                                        child: ( widget.spProGuessInfo.spProIconUrlTwo.isEmpty)? SPClassEncryptImage.asset(
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(width: 4,),
                                      Text(spProBestPlayerList.oen.score.score,style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("${spProBestPlayerList.two.score.score}",style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                      SizedBox(width: 4,),
                                      Expanded(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.end,
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("${spProBestPlayerList.oen.rebound.rebound}",style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>[
                                      Text("${spProBestPlayerList.two.rebound.rebound}",style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                      SizedBox(width: 4,),
                                      Expanded(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.end,
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(width: 4,),
                                      Text("${spProBestPlayerList.oen.assist.assist}",style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>[
                                      Text("${spProBestPlayerList.two.assist.assist}",style: GoogleFonts.roboto(fontSize: sp(13),textStyle: TextStyle(color: Color(0xFFE3494B)),fontWeight: FontWeight.w500),),
                                      SizedBox(width: 4,),
                                      Expanded(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.end,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 4,),
                          Text("球队数据",style: GoogleFonts.notoSansSC(fontWeight: FontWeight.w500,fontSize: sp(14)),),
                          Expanded(
                            child: SizedBox(),
                          ),
                          GestureDetector(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 4,),
                          Text("球员数据",style: GoogleFonts.notoSansSC(fontWeight: FontWeight.w500,fontSize: sp(14)),),
                          Expanded(
                            child: SizedBox(),
                          ),
                          GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              height: width(33),
                                              width: width(88),
                                              child: Text( index==0 ? "球员":item.spProPlayerName,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ?  FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                            ),
                                            Container(
                                              color: Color(0xFFDDDDDD),
                                              height: width(33),
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                Container(
                                                  ...
                                                  height: width(33),
                                                  width: width(46.5),
                                                  child: Text(index==0 ?  "状态":(item.spProIsRegular=="1")? "首发":"替补",style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                Container(
                                                  alignment: Alignment.center,
                                                  height: width(33),
                                                  width: width(46.5),
                                                  child: Text(index==0 ?  "时间":item.spProPlayingTime,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                ...
                                                Container(
                                                  ...
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "投篮":item.shot,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                ...
                                                Container(
                                                  ...
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "三分":item.spProThreePoint,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                Container(
                                                  alignment: Alignment.center,
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "罚球":item.spProFreeThrow,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                Container(
                                                  color: Color(0xFFDDDDDD),
                                                  height: width(33),
                                                ...
                                                Container(
                                                  ...
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "抢断":item.steal,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                ...
                                                Container(
                                                  ...
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "盖帽":item.spProBlockShot,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                Container(
                                                  alignment: Alignment.center,
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "失误":item.turnover,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                                Container(
                                                  alignment: Alignment.center,
                                                  height: width(33),
                                                  width: width(48),
                                                  child: Text(index==0 ?  "犯规":item.foul,style: GoogleFonts.notoSansSC(fontSize: sp(11),fontWeight:index==0 ? FontWeight.w500:null),textAlign: TextAlign.center,maxLines: 2,overflow:TextOverflow.ellipsis,),
                                                ),
                                              ],
                                            ),
                                          );
  ...
  void spFunGetLiveText(String refSeqNum) async{
    ...
    SPClassApiManager.spFunGetInstance().spFunTextLive<SPClassTextLiveListEntity>(context: context,spProGuessMatchId: widget.spProGuessInfo.spProGuessMatchId,refSeqNum:refSeqNum,spProCallBack: SPClassHttpCallBack(
        spProOnSuccess: (result) async{
          if(result.spProTextLiveList!=null&&result.spProTextLiveList.length>0){
          ...
          if(result.spProGuessMatch!=null&&result.spProGuessMatch.spProIsRealtimeOver=="0"){
            ...
            await Future.delayed(Duration(seconds: 3),(){
              spFunGetLiveText(spProOrgTextData.length==0? "":spProOrgTextData[0].spProSeqNum);
            });
          }
        },
