...
class SPClassMatchAnylizeBasketBallPage extends StatefulWidget{
  Map<String,dynamic> params;
  SPClassGuessMatchInfo spProGuessMatch;
  SPClassMatchAnylizeBasketBallPage(this.params,this.spProGuessMatch);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return SPClassMatchAnylizeBasketBallPageState();
  }

}

class SPClassMatchAnylizeBasketBallPageState extends State<SPClassMatchAnylizeBasketBallPage> with AutomaticKeepAliveClientMixin,TickerProviderStateMixin{
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Visibility(
                                  ...
                                  visible: SPClassListUtil.spFunIsNotEmpty(spFunGetTeamPoints(spProPointsKey))&&double.tryParse(spFunGetTeamPoints(spProPointsKey)[0].points)>0,
                                ),
                                ...
                                Expanded(
                                  child: Container(
                                    alignment: Alignment.center,
                                    height:width(40),
                                    child: Text("胜/负",style: TextStyle(fontSize: sp(11),color: Color(0xFF888888)),),
                                  ),
                                ) ,
                                Container(
                                  alignment: Alignment.center,
                                    ...
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.center,
                                          height:width(40),
                                          child: Text(sprintf("%s/%s",[item.spProWinNum,item.spProLoseNum]),style: TextStyle(fontSize: sp(11),fontWeight: FontWeight.w500),),
                                        ),
                                      ) ,
                                      Container(
                                        alignment: Alignment.center,
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            spFunGetMatchRate(spFunGetHistoryList(spProHistoryKey),2)==0? SizedBox(): Container(
                              alignment: Alignment.center,
