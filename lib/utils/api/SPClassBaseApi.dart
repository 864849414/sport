...
import 'package:sport/utils/api/SPClassHttpManager.dart';
...
class SPClassBaseApi{
  ...
  //GET请求
  Future<void> spFunGet<T>({Object jsonObject,String url,Map<String,dynamic> queryParameters,bool isBaseParams:true,bool spProIsLoading:false,bool isToast:false,bool isTimeOut,BuildContext context,SPClassHttpCallBack<T> spProCallBack,bool isDemo}) async {
