...
import 'package:sport/model/SPClassCheckUpDate.dart';
...
import 'package:sport/model/SPClassUserSchemeListEntity.dart';
import 'package:sport/utils/api/SPClassBaseApi.dart';
...
*/
 ...
 /* Future<ResultData> addComment(BuildContext context, bool showProgress,Map<String,dynamic> params) async {
  ...
  spFunReadMsg({SPClassHttpCallBack spProCallBack,BuildContext context,Map<String,dynamic> queryParameters}){
    spFunGet<SPClassBaseModelEntity>(url: READ_MSG,queryParameters:queryParameters,isToast: false,spProIsLoading: false,isBaseParams: true,spProCallBack: spProCallBack);
  }
  ...
  spFunLoginByCode({String spProPhoneNumber ,String spProPhoneCode ,String spProInviteCode,SPClassHttpCallBack spProCallBack,BuildContext context}){
    spFunGet<SPClassUserLoginInfo>(jsonObject:new SPClassUserLoginInfo(),url: LOGIN_BY_CODE,queryParameters:{"phone_number":spProPhoneNumber,"phone_code":spProPhoneCode,"invite_code":spProInviteCode},isToast: true,spProIsLoading: true,isBaseParams: false, spProCallBack: spProCallBack ,context: context);
  }
  spFunUserLogin({Map<String,dynamic> queryParameters,Map<String,dynamic> spProBodyParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunUserChangePwd({Map<String,dynamic> queryParameters,Map<String,dynamic> spProBodyParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunUserLoginByWx({BuildContext context,String spProWxCode,SPClassHttpCallBack spProCallBack}) async {
   ...
   spFunUserRegister({Map<String,dynamic> queryParameters,Map<String,dynamic> spProBodyParameters,SPClassHttpCallBack spProCallBack,BuildContext context}) async {
  ...
  spFunMatchOddsList({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack}){
    spFunGet<SPClassSsOddsList>(url: spProMATCH_ODDS_LIST,queryParameters:queryParameters,spProCallBack: spProCallBack );
  }
  spFunMatchAnalyse({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack}){
    spFunGet<SPClassAnylizeMatchList>(url: MATCH_ANALYSE,queryParameters:queryParameters,spProCallBack: spProCallBack );
  }

  spFunSendCode({BuildContext context,SPClassHttpCallBack spProCallBack,String spProPhoneNumber,String spProCodeType}) async {
  ...
  spFunComplain({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}) async {
  ...
  spFunAddCollect({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}) async {
  ...
  spFunCancelCollect({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}) async {
  ...
  spFunExpertApply({Map<String,dynamic> spProBodyParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunSchemeDetail({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunSchemeBuy({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunCreateOrder({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunGetOrderStatus({String spProOrderNum,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunCancelOrder({String spProOrderNum,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunCollectMatch({String matchId,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunDelUserMatch({String matchId,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunExpertList({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack,spProIsLoading: false,BuildContext context}){
  ...
  Future<void>  spFunSchemeList({Map<String,dynamic> queryParameters,SPClassHttpCallBack spProCallBack}){
  ...
  Future<void>  spFunGuessMatchList<T>({Map<String,dynamic> queryParams,SPClassHttpCallBack< SPClassListEntity<T>>  spProCallBack,BuildContext buildContext}){
    return spFunGet< SPClassListEntity<T>>(jsonObject:new SPClassListEntity<T>(key: "guess_match_list",object: new SPClassGuessMatchInfo()),url: GUESS_MATCH_LIST,queryParameters:queryParams,isToast: false,spProIsLoading: true,isBaseParams: true, spProCallBack: spProCallBack,context: buildContext );
  }
  ...
  spFunShowPConfig({SPClassHttpCallBack spProCallBack}){
  ...
  spFunFollowExpert({bool isFollow,String spProExpertUid,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunOddsHistoryList({String spProOddsType,String company,String spProGuessMatchId,SPClassHttpCallBack spProCallBack,BuildContext context}){
  ...
  spFunDoUpdateAvatar({String fileName,SPClassHttpCallBack spProCallBack,BuildContext context,List<File> files}){
  ...
  spFunUploadFiles({String fileName,SPClassHttpCallBack spProCallBack,BuildContext context,List<File> files,Map<String,dynamic> params,}){
